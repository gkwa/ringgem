...
url=$(/usr/local/bin/allbranding query --releases-url=https://api.github.com/repos/equinix-labs/otel-cli/releases --asset-regex='otel-cli.*_linux_amd64.tar.gz' | jq -r .browser_download_url)
